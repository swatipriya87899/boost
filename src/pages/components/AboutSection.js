...
const AboutSection = () => {
  return (
    <div className='secondary_text_color tertiary_background_color padding'>
        ...
        <div className='text'>We link Brands who are looking for Authentic Partnership with influencers who generate Millions of view each months, We know how to use social media to Booost Business Result with Revenue.</div>
